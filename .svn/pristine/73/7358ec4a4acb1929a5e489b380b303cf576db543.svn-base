...
function ClientSideStrongPassword(){
	return (IsLongEnough(ClientSideStrongPassword.arguments[0], "6") && SpansEnoughCharacterSets(ClientSideStrongPassword.arguments[0], "3") && (!(IsCloseVariationOfAWordInDictionary(ClientSideStrongPassword.arguments[0], "0.6", ClientSideStrongPassword.arguments[1], ClientSideStrongPassword.arguments[2]))));
}

function ClientSideBestPassword(){
	return (IsLongEnough(ClientSideBestPassword.arguments[0], "10") && SpansEnoughCharacterSets(ClientSideBestPassword.arguments[0], "3") && (!(IsCloseVariationOfAWordInDictionary(ClientSideBestPassword.arguments[0], "0.6", ClientSideBestPassword.arguments[1], ClientSideBestPassword.arguments[2]))));
}
...
function DispPwdStrength(iN,sHL){ 
	...
	for(var i=0;i<3;i++){ 
		var sHCR = "";
		if(i <= iN){sHCR = sHL;}
		if(iN == 1){GEId("idSM0").className = sHL;}
		if(iN == 0){GEId("idSM0").className = sHL;}
		if(iN == 2){GEId("idSM0").className = sHL;}
		if(i>0){ 
